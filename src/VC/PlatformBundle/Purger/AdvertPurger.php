<?php
namespace VC\PlatformBundle\Purger;
...
class AdvertPurger
{
  ...
  {
    $advertRepository      = $this->em->getRepository('VCPlatformBundle:Advert');
    $advertSkillRepository = $this->em->getRepository('VCPlatformBundle:AdvertSkill');
